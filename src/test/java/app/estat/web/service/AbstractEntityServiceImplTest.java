...
public abstract class AbstractEntityServiceImplTest<E extends Entity> {
    ...
    public void testSaveEntity() throws IllegalAccessException, ParseException {
        ...
        for (E entity : entities) {
            ...
            assertTrue(Util.assertPropertiesEquals(savedEntity, readEntity, clazz));
        }
    }
    ...
    public void testGetAllEntities() throws ParseException, IllegalAccessException {
        ...
        for (int i = 0; i <= 18; i += 2) {
            Util.assertPropertiesEquals(entities.get(i), readEntities.get(i), clazz);
            Util.assertPropertiesEquals(entities.get(i + 1), readEntities.get(i + 1), clazz);
        }
    }
    ...
    public void testUpdateEntity() throws ParseException, IllegalAccessException {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            assertTrue(Util.assertPropertiesEquals(updatedEntity, readEntity, clazz));
